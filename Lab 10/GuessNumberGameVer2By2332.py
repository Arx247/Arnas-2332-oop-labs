#Arnas Oonsadao
#633040233-2
#Lab 10. Using OOP to Develop GuessNumberGame : P2
from GuessNumberGameVer1By2332 import GuessNumberGameVer1
...
if __name__ == "__main__":
    #Show
    gng1 = GuessNumberGameVer2()
    gng1.playgame()
    print("Now let's play only one game")
    gng1.playgame()
    gng2 = GuessNumberGameVer2(5, 8)
    gng3 = GuessNumberGameVer2(5, 8, 4)
    print(gng3)
    print(f"The current number of game is {GuessNumberGameVer2.getNumofGame()}")
    gng3.playgame()